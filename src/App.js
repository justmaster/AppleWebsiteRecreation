...
function App() {
  ...
  <div className="header"></div>
    ...
    <div className="hero iphone-11-pro">
      <div className="container">
        <div className="title">
          <h2 className="title-heading">Новый Колбасный Цех</h2>
          <h3 className="title-sub-heading">Pro cameras. Pro display. Pro performance.</h3>
